...
def test_get_new_df(spark_fixture):
    ...
    diff = DeepDiff(get_new_df(extraction_df, existing_df, args['args']['partitioning_column'], "2019-01-02"), expected_new_df, ignore_string_case=False)
    assert diff == {}, "wrong new df"
