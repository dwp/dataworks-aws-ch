    ...
    "logs_collected": {
      "files": {
        "collect_list": [
          ...
          {
            "file_path": "/var/log/dataworks-aws-ch/steps-setup.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-steps-setup.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/dataworks-aws-ch/metadata.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-metadata.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/dataworks-aws-ch/config_hcs.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
          ...
          {
            "file_path": "/var/log/dataworks-aws-ch/install-zipfile.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-install-zipfile.log",
            "timezone": "UTC"
          },
          {
