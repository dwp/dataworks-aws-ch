...
module "ch_iam" {
  ...
  local_common_tags             = local.common_repo_tags
  local_environment             = local.environment
  data_ch_writer_secret_arn     = data.terraform_remote_state.internal_compute.outputs.metadata_store_users.ch_writer.secret_arn
...
module "ch_s3" {
  ...
  data_config_bucket_id                  = data.terraform_remote_state.common.outputs.config_bucket.id
  data_config_bucket_arn                 = data.terraform_remote_state.common.outputs.config_bucket.arn
  data_stage_bucket                      = data.terraform_remote_state.common.outputs.data_ingress_stage_bucket.id
  data_config_bucket_cmk_arn             = data.terraform_remote_state.common.outputs.config_bucket_cmk.arn
  local_ch_version                       = local.ch_version
  local_environment                      = local.environment
  ...
  local_ch_log_level                     = local.ch_log_level
  ...
  data_subnet_ids                        = data.terraform_remote_state.internal_compute.outputs.ch_subnet.ids
  ...
  data_ch_writer                         = data.terraform_remote_state.internal_compute.outputs.metadata_store_users.ch_writer
...
module "ch_security_groups" {
  ...
  data_ch_cidr_blocks          = data.terraform_remote_state.internal_compute.outputs.ch_subnet.cidr_blocks
